...
// @HASH:d91ef068103c7724d9c19d453f2c62e9bca24354
// @DATE:Sat Apr 20 22:33:50 CEST 2013
...
// @LINE:23
private[this] lazy val controllers_api_Stats_get14 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/stats"))))
        

// @LINE:26
private[this] lazy val controllers_dev_Util_testRes15 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/dev/util/testRes/"),DynamicPart("service", """[^/]+""",true))))
        

// @LINE:27
private[this] lazy val controllers_dev_Util_testSkimboRes16 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/dev/util/testSkimboRes/"),DynamicPart("service", """[^/]+""",true))))
        

// @LINE:28
private[this] lazy val controllers_dev_Util_staticRes17 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/dev/util/staticRes"))))
        

// @LINE:29
private[this] lazy val controllers_dev_Util_deleteUser18 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/dev/util/delDb"))))
        

// @LINE:30
private[this] lazy val controllers_dev_Util_deleteAllUsers19 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/dev/util/delAllDb/"),DynamicPart("pwd", """[^/]+""",true))))
        

// @LINE:31
private[this] lazy val controllers_dev_Util_userRes20 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/dev/util/userRes/"),DynamicPart("p", """[^/]+""",true))))
        

// @LINE:32
private[this] lazy val controllers_dev_Util_userDistantRes21 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/dev/util/userDistant/"),DynamicPart("p", """[^/]+""",true))))
        

// @LINE:33
private[this] lazy val controllers_dev_Util_invalidToken22 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/dev/util/invalidToken/"),DynamicPart("p", """[^/]+""",true),StaticPart("/"),DynamicPart("pwd", """[^/]+""",true))))
        

// @LINE:34
private[this] lazy val controllers_dev_Util_urlTest23 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/dev/util/urlTest/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:36
private[this] lazy val controllers_Application_downloadDistant24 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("download/"),DynamicPart("url", """[^/]+""",true))))
...
// @LINE:23
case controllers_api_Stats_get14(params) => {
   call { 
...
// @LINE:26
case controllers_dev_Util_testRes15(params) => {
...
// @LINE:27
case controllers_dev_Util_testSkimboRes16(params) => {
   call(params.fromPath[String]("service", None)) { (service) =>
...
// @LINE:28
case controllers_dev_Util_staticRes17(params) => {
   call { 
...
// @LINE:29
case controllers_dev_Util_deleteUser18(params) => {
   call { 
...
// @LINE:30
case controllers_dev_Util_deleteAllUsers19(params) => {
...
// @LINE:31
case controllers_dev_Util_userRes20(params) => {
...
// @LINE:32
case controllers_dev_Util_userDistantRes21(params) => {
   call(params.fromPath[String]("p", None)) { (p) =>
...
// @LINE:33
case controllers_dev_Util_invalidToken22(params) => {
...
// @LINE:34
case controllers_dev_Util_urlTest23(params) => {
...
// @LINE:36
case controllers_Application_downloadDistant24(params) => {
   call(params.fromPath[String]("url", None)) { (url) =>
        invokeHandler(controllers.Application.downloadDistant(url), HandlerDef(this, "controllers.Application", "downloadDistant", Seq(classOf[String]),"GET", """""", Routes.prefix + """download/$url<[^/]+>"""))
   }
}
