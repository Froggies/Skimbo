...
// @DATE:Tue Apr 09 22:25:39 CEST 2013
...
// @LINE:6
private[this] lazy val controllers_api_Providers_delete4 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/providers/del/"),DynamicPart("provider", """[^/]+""",true))))
...
// @LINE:10
private[this] lazy val controllers_Application_authenticate7 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("auth/"),DynamicPart("provider", """[^/]+""",true))))
...
// @LINE:24
private[this] lazy val controllers_dev_Util_testRes13 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/dev/util/testRes/"),DynamicPart("service", """[^/]+""",true))))
        

// @LINE:25
private[this] lazy val controllers_dev_Util_testSkimboRes14 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/dev/util/testSkimboRes/"),DynamicPart("service", """[^/]+""",true))))
...
// @LINE:28
private[this] lazy val controllers_dev_Util_deleteAllUsers17 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/dev/util/delAllDb/"),DynamicPart("pwd", """[^/]+""",true))))
        

// @LINE:29
private[this] lazy val controllers_dev_Util_userRes18 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/dev/util/userRes/"),DynamicPart("p", """[^/]+""",true))))
        

// @LINE:30
private[this] lazy val controllers_dev_Util_userDistantRes19 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/dev/util/userDistant/"),DynamicPart("p", """[^/]+""",true))))
        

// @LINE:31
private[this] lazy val controllers_dev_Util_invalidToken20 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/dev/util/invalidToken/"),DynamicPart("p", """[^/]+""",true),StaticPart("/"),DynamicPart("pwd", """[^/]+""",true))))
        

// @LINE:32
private[this] lazy val controllers_dev_Util_urlTest21 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("api/dev/util/urlTest/"),DynamicPart("id", """[^/]+""",true))))
