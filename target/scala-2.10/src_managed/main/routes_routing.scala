...
// @DATE:Wed May 01 17:59:20 CEST 2013
...
// @LINE:36
private[this] lazy val controllers_Application_downloadDistant24 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("download"))))
